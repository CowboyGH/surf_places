...
class EmptyFavoritesListWidget extends StatelessWidget {
  const EmptyFavoritesListWidget({super.key});
  ...
  Widget build(BuildContext context) {
    ...
    return Column(
      ...
      children: [
        SvgPictureWidget(AppSvgIcons.icGo, height: 64, color: colorTheme.textInactive),
        const SizedBox(height: 24),
        Text(
          AppStrings.emptyFavoritesListWidgetMessage,
